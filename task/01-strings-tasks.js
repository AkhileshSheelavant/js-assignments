 ...
 */
function getStringFromTemplate(firstName, lastName) {                       // Not solved
 ...
 */
function extractNameFromTemplate(value) {                               // Not solved
    throw new Error('Not implemented');
}
...
function encodeToRot13(str) {
    ...
    for(var i=0;i<str.length;i++)
    {
        ...
        {
            var sum=((str.charAt(i)).charCodeAt(0))+13;
            if(sum>90)
            {
                sum= 65+12-(90-((str.charAt(i)).charCodeAt(0)));
        ...
        else if((str.charAt(i)).charCodeAt(0)>=97 && (str.charAt(i)).charCodeAt(0)<=122)
        {
            ...
            if(sum>122)
            {
                sum= 97+12-(122-((str.charAt(i)).charCodeAt(0)));
                s+=String.fromCharCode(sum);
            }
